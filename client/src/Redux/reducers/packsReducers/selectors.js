...
export const selectNormalizedDegustationData = createSelector(selectDegustationData, degustation => changeData(degustation, 'degustation'))
...
export const selectNormalizedPacksData = createSelector(selectPacksData, packs => changeData(packs, 'packs'))
